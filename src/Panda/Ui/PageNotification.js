(function ($) {
    ...
    Panda.Ui.PageNotification = $.extend(Panda.Ui.PageNotification || {}, {
        show: function (title, notification_id, notification_type, timeout, options) {
            ...
            var notification = Panda.Ui.DOM.create('div', '', notification_id, 'ui-page-notification').addClass(notification_type);
            ...
            // Icon
            Panda.Ui.DOM.create('div', '', '', 'page-notification-icon').appendTo(notification);

            // Title
            Panda.Ui.DOM.create('div', title, '', 'page-notification-title').appendTo(notification);
